...
projects[commerce_coupon][download][url] = "git://git.drupal.org/project/commerce_coupon.git"
...
projects[commerce_discount][download][url] = "git://git.drupal.org/project/commerce_discount.git"
...
projects[commerce_empty_cart_paths][download][type] = "git"
projects[commerce_empty_cart_paths][download][url] = "git://git.drupal.org/project/commerce_empty_cart_paths.git"
projects[commerce_empty_cart_paths][download][branch] = "7.x-1.x"
...
projects[payment][download][type] = "git"
projects[payment][download][url] = "git://git.drupal.org/project/payment.git"
projects[payment][download][branch] = "7.x-1.x"
projects[payment_commerce][subdir] = "contrib"
projects[payment_commerce][download][type] = "git"
projects[payment_commerce][download][url] = "git://git.drupal.org/project/payment_commerce.git"
projects[payment_commerce][download][branch] = "7.x-1.x"
